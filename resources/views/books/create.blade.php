    ...
    <main class="flex-1 overflow-y-auto p-6 bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow-md rounded-lg p-6">
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Add A New Book</h3>
                    <p class="text-sm text-gray-600">Please fill in the informations needed to add a new book to the library.
                    </p>
                </div>
